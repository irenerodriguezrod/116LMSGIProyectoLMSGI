<!--
    ...
    Versión utilizada en xPath: 1.0
-->
...
<!--
    Ejemplos realizados en clase con la explicación de las rutas de localización y los comodines. Presentación páginas 18 - 20
-->

## Otros ejemplos realizados en clase.

1. Nombre de la universidad que contiene la palabra 'Victoria' 
```
/universidad/nombre[contains(./text(),"Victoria")]/text() 
```